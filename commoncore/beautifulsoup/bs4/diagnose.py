...
import commoncore.beautifulsoup.bs4
from commoncore.beautifulsoup.bs4 import BeautifulSoup, __version__
from commoncore.beautifulsoup.bs4.builder import builder_registry
